 ...
 * @brief On join
 */
class Join final : public ServerEvent {
private:
...
public:
	 ...
	 * @param origin the nickname who joined the channel (may be you)
	 * @param channel the channel
	 */
	Join(std::shared_ptr<Server> server, std::string origin, std::string channel);
